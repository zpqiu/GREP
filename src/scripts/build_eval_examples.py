...
def build_examples(rank: int, 
    ...
    def _padding_history(hists: List[str], max_count: int = 10) -> Tuple[List[str], int]:
        ...
        for row in loader:
            ...
            for sample in samples:
                ...
                data = convert_kgdata(nodes=nodes, edges=edge_index, bi_edges=bi_edge_index, 
                                      ...
                                      label=label, imp_id=row[-1], max_hist_len=args.max_hist_length)
...
def main(args):
    ...
    for i in range(args.processes):
        output_path = os.path.join(ROOT_PATH, "data", args.fsize, args.fout, "valid_set_dist-{}.pt".format(i))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fsize", default="L", type=str,
                        help="Corpus size")
    parser.add_argument("--fnews", default="dev/news.tsv", type=str,
                        help="Path of the news info file.")
    parser.add_argument("--fsamples", default="dev/behaviors.small.tsv", type=str,
    ...
    parser.add_argument("--fhist", default="dev-user_hist_dict.txt", type=str,
